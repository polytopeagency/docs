...
FOAM's material presets (Water, Seawater, Soap Solution, Glycerol, Honey, Olive Oil, Mercury, Ethanol, Molasses) use measured physical properties of real liquids. When you adjust Liquid Mass, Tension, and Viscosity manually, you're directly controlling the physical parameters of the simulation.

## Resonator Bodies

FOAM also includes a modal resonator that simulates the acoustic body that bubbles resonate inside. Eleven physics-derived presets — from a Glass Jar to an entire Cave — apply real measured mode frequencies, Q values, and amplitudes. The resonator can pitch-track to incoming MIDI in Melodic and Harmonic flow types, turning the body into a tunable instrument.
